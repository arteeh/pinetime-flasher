...
on_activate (GtkApplication *app)
{
	...
	if (window == NULL)
		window = g_object_new (PINETIME_COMPANION_TYPE_WINDOW,
				       "application", app,
				       NULL);
...
int main (int argc, char *argv[])
{
	...
	*/
	app = gtk_application_new ("com.arteeh.PineTime-Companion", G_APPLICATION_FLAGS_NONE);
	...
	*/
	...
	This is the code you see when you do `echo $?` after running a command
	in a terminal. Since GtkApplication inherits from GApplication, we use
	the parent class method "run". But we need to cast, which is what the
